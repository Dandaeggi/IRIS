...
const responseTitlebarContext = {
  exit() {
    ipcRenderer.invoke("response-close");
  },
  undo() {
...
export type ResponseTitlebarContextApi = typeof responseTitlebarContext;

export default responseTitlebarContext;
